...
# %%
#food_noalcnovit.loc[:, 'total_weights_s'] = len (food_noalcnovit)
#food_noalcnovit[food_noalcnovit['wti_UKY1234rs'] > 0, 'total_weights_s'] = 4. / 11. * len (food_noalcnovit[food_noalcnovit['wti_UKY1234rs'] > 0]) / food_noalcnovit.loc[food_noalcnovit['wti_UKY1234rs'] > 0, 'total_weights_s']
#food_noalcnovit[food_noalcnovit['wti_Y56rs'] > 0, 'total_weights_s']     = 2. / 11. * len (food_noalcnovit[food_noalcnovit['wti_Y56rs'] > 0]) / food_noalcnovit.loc[food_noalcnovit['wti_Y56rs'] > 0, 'total_weights_s']
#food_noalcnovit[food_noalcnovit['wti_Y78rs'] > 0, 'total_weights_s']     = 2. / 11. * len (food_noalcnovit[food_noalcnovit['wti_Y78rs'] > 0]) / food_noalcnovit.loc[food_noalcnovit['wti_Y78rs'] > 0, 'total_weights_s']
#food_noalcnovit[food_noalcnovit['wti_Y911rs'] > 0, 'total_weights_s']    = 3. / 11. * len (food_noalcnovit[food_noalcnovit['wti_Y911rs'] > 0]) / food_noalcnovit.loc[food_noalcnovit['wti_Y911rs'] > 0, 'total_weights_s']
#food_noalcnovit.loc[:, 'total_weights_s'] = food_noalcnovit.loc[:, 'total_weights_s'] / np.mean (food_noalcnovit.loc[:, 'total_weights_s'])


# %%
food_noalcnovit.loc[:, 'total_weights_s'] = food_noalcnovit.loc[:, 'total_weights'] / np.mean (food_noalcnovit.loc[:, 'total_weights'])
